...
export function MiddleHeroItem({ id, title, img, content }: MiddleHeroItemType) {
    ...
    return (
        ...
        >
            ...
            <Grid
                ...
                alignItems="center"
            >
                <Typography variant="h1" sx={{ mt: 2 }} fontSize={smallScreen ? '18px' : '24px'} textAlign={'center'} fontWeight={500}>
                    {title}
                </Typography>
                <List>
                    {content.map((item) => {

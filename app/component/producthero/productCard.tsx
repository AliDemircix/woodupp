...
export default function ProductCard({ selectedProductDetails, selectedSmallImageId }: Props) {
    const selectedProductImage = selectedProductDetails?.thumbnailImages.find((i) => i.id === selectedSmallImageId);
